...
Insert into E3T5.PRODUKTU (ID,IZENA,DESKRIBAPENA,BALIOA,SALNEURRIA,ID_KATEGORIA) values ('289','Produktufroga','FROOOOOOOOOOOOOOOOOOOOOOOOOOOOGA','123,22','233,11','1');
Insert into E3T5.PRODUKTU (ID,IZENA,DESKRIBAPENA,BALIOA,SALNEURRIA,ID_KATEGORIA) values ('290','froga','FROOOOOOGA','123,55','123,2','2');
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "E3T5"."T_STOCK_GEHITU" 
...
END;
/
ALTER TRIGGER "E3T5"."T_STOCK_GEHITU" ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_STOCK_GEHITU
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "E3T5"."PASAHITZA_EGUNERATU" (
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "E3T5"."P_INFO_BEZERO" ( V_BEZERO_ID IN BEZERO.ID%TYPE,
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "E3T5"."P_PRODUKTU_PREZIOA_EGUNERATU" AS
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "E3T5"."P_REESTOCK" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "E3T5"."F_KALKULATU_STOCK" ( 
